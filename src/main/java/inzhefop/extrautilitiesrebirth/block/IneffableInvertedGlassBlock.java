...
public class IneffableInvertedGlassBlock extends ModAbstractGlassBlock {
	...
	public void appendHoverText(@NotNull ItemStack itemStack, @Nullable BlockGetter world, @NotNull List<Component> list, @NotNull TooltipFlag flag) {
		...
		list.add(new TranslatableComponent("tooltip.extrautilitiesrebirth.ineffable_inverted_glass").withStyle(ChatFormatting.GRAY));
	}
