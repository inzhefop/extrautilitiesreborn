...
public class EnchanterGUIScreen extends AbstractContainerScreen<EnchanterGUIMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		}.getEnergyStored(world, new BlockPos(x, y, z)) / 3571.4;
		int pwr = (int) power;
		...
		this.blit(ms, this.leftPos + 78, this.topPos + 35, 0, 0, 22, 15, 22, 15);
		...
		this.blit(ms, this.leftPos + 78, this.topPos + 35, 0, 0, ttt, 15, ttt, 15);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "Enchanter", 7, 5, -12829636);
	}
